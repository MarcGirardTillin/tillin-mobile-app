...
- Never use modules removed from React Native such as the old core Picker, WebView, SafeAreaView, or AsyncStorage (use @react-native-picker/picker for pickers)
